...
const LeadersList = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        const dataWithTotalValue = data.map((player) => ({
          ...player,
          totalValue: calculatePlayerValue(player).totalValue,
        }));

        setPlayers(dataWithTotalValue);
      } catch (error) {
  ...
  const renderPlayers = (category) => {
    ...
    console.log(
      `Rendering top 10 players for category ${category}:`,
      sortedPlayers
    );
    return (
      <div className="mt-5">
    ...
    <div className="container mx-auto px-4">
      ...
      <div className="max-w-md mx-auto">
        ...
        >
          ...
          <option value="threePA">
            Three-Point Field Goals Attempted (3PA)
          </option>
          <option value="threePPercent">
          ...
          <option value="twoPPercent">
            Two-Point Field Goal Percentage (2P%)
          </option>
          <option value="eFGPercent">
