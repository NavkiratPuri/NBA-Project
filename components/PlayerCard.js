...
const PlayerCard = ({ player, onRemove, customClasses, weights }) => {
  ...
  const {
    ...
    mpValue,
    ageValue,
  } = calculatePlayerValue(player, weights);
          ...
          <div>
            ...
            <div className="flex items-center">
              <img
                src={player.teamLogo}
                alt={player.Tm}
                className="w-11 h-11 rounded-full border-1 border-gray-600"
              />
        ...
        {view === 2 && (
          <div className="text-sm">
            ...
            <div className="grid grid-cols-3 text-xs ">
              ...
              <p>MPG: {mpValue}</p>
              <p></p>
              <p className="text-blue-500 font-bold text-base text-right">
                {totalValue}
              </p>
            </div>
          </div>
